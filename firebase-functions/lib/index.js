...
exports.updateTaskStatistics = exports.sendTaskCompletionNotification = exports.markTaskDone = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// Inicializar Firebase Admin SDK
admin.initializeApp();
// Cloud Function para "Mark as Done"
exports.markTaskDone = functions.https.onRequest(async (req, res) => {
    try {
...
exports.sendTaskCompletionNotification = functions.firestore
...
exports.updateTaskStatistics = functions.firestore
    .document('tasks/{taskId}')
    .onUpdate(async (change, context) => {
    const newValue = change.after.data();
    const previousValue = change.before.data();
